...
public class AppointmentMapper {
  ...
  public AppointmentResponse mapToResponse(AppointmentEntity appointment) {
    ...
    return AppointmentResponse.builder()
        ...
        .branchId(appointment.getBranch() != null ? appointment.getBranch().getId() : null)
        .branchName(appointment.getBranch() != null ? appointment.getBranch().getName() : "Deleted Branch")
